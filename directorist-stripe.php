...
if (!class_exists('Directorist_Stripe_Gateway')) {
    final class Directorist_Stripe_Gateway
    {
        ...
        public static function instance()
        {
            ...
            if (!isset(self::$instance) && !(self::$instance instanceof self)) {
                ...
                self::$instance->use_sandbox = get_directorist_option('gateway_test_mode', true);
        ...
        public function atbdp_listing_type_settings_field_list($stripe_fields)
        {
            ...
            $stripe_fields['stripe_gateway_note'] = [
                'type'               => 'note',
                'title'              => __('Note About Stripe Gateway:', 'directorist-stripe'),
            ...
            $submenu['stripe'] = [
                ...
                'sections'   => apply_filters('atbdp_stripe_settings_controls', [
                    'gateways' => [
                        ...
                        'fields'        =>  ['stripe_gateway_note', 'stripe_gateway_title', 'stripe_gateway_description', 'stripe_live_pk', 'stripe_live_sk', 'stripe_test_pk', 'stripe_test_sk', 'tex_rate', 'stripe_repeated_lib'],
                    ],
                ]),
            ];
        ...
        private function includes()
        {
            ...
            $license_key = trim(get_option('directorist_stripe_license'));
    ...
    if (directorist_is_plugin_active('parking-safe/directorist-base.php')) {
        Directorist_Stripe();
    }
}
